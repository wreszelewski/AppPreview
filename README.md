...
You only have to prepare an api method, configure website properly and serve this project as static content.
...
This methods are available on localhost:8080/.
